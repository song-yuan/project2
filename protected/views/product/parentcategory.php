...
<?php foreach($parentCategorys as $categorys):?>
	...
	<a href="<?php echo $this->createUrl('/product/index',array('pid'=>$categorys['category_id'],'category'=>$category['category_id'],'type'=>$type));?>"><div class="catename"><?php echo $category['category_name'];?></div></a>
	<?php endforeach;?>
	<div class="clear"></div>
	</div>
<?php endforeach;?>
